    ...
    <>
      <nav className={`navbar sticky-top shadow navbar-expand-lg navbar-${props.mode.classname}`} style={{ backgroundColor: props.mode.colorCode }}>
        <div className="container-fluid">
          <Link className="navbar-brand fw-bold" style={{ letterSpacing: "2px" }} to="/First-react-app">{props.title}</Link>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              <li className="nav-item">
                <Link className="nav-link active" aria-current="page" to="/First-react-app">Home</Link>
              </li>
              <li className="nav-item">
